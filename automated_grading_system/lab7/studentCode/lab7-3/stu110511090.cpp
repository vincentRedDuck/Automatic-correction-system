...
void showMatrix(int row, int col, int matrix[MAXSIZE][MAXSIZE]){
    for(int i = 0; i < row; i++){
        for(int j = 0; j < col; j++){
...
void random(int row, int col, int matrix[MAXSIZE][MAXSIZE]){
    for(int i = 0; i < row; i++){
        for(int j = 0; j < col; j++){
            matrix[i][j] = rand()%100;
        }
...
void mul(int matrix1[][MAXSIZE], int matrix2[][MAXSIZE], int matrix3[][MAXSIZE],int numrow, int numcol1, int numcol2){
