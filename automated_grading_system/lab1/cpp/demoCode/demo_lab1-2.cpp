...
//--------------- need to rewrite ---------------------
#define LABNUMBER "lab1" //format "lab#", # is number of exercise
#define EXNUMBER "ex1" //format "ex#", # is number of exercise
#define EXERCISENUMBER "2" //format "#", # is number of exercise
...
void setEndTime(time_t &due_t){  // score will change 0.7 after the deadline. 
    ...
    timeStruct->tm_mon=10-1;   // -1 is mean that the range is 0 to 11.
...
int main(){
    ...
    string codename = charToString(EXNUMBER) + charToString("-") + charToString(EXERCISENUMBER) + charToString("_demo.zip");
